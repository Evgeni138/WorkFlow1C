---
name: 1c-web-session
description: "Этот скилл MUST быть вызван для управления 1С:Предприятие в веб-клиенте через Playwright MCP: запуск/перезапуск/завершение сеанса, навигация, создание и редактирование справочников и документов. SHOULD также вызывать для генерации тестовых данных через UI и сценарного тестирования в браузере. Do NOT использовать для scaffold автотестов — используй playwright-test."
---
