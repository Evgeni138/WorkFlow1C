---
name: cfe-borrow
description: "Этот скилл MUST быть вызван когда нужно заимствовать объект из конфигурации в расширение (CFE): перехватить метод, изменить форму, добавить реквизит. SHOULD также вызывать как первый шаг при создании patch-расширений. Do NOT использовать для создания расширения — используй cfe-init."
---
