---
name: cfe-diff
description: "Этот скилл MUST быть вызван когда нужно проанализировать состав расширения (CFE): заимствованные объекты, перехватчики, проверить перенесены ли вставки. SHOULD также вызывать перед деплоем расширения в производство. Do NOT использовать для валидации расширения — используй cfe-validate."
---
