---
name: cfe-init
description: "Этот скилл MUST быть вызван когда пользователь просит создать новое расширение конфигурации (CFE) для исправления, доработки или дополнения. SHOULD также вызывать когда нужно изменить типовую конфигурацию без прямых правок. Do NOT использовать для заимствования объектов — используй cfe-borrow."
---
