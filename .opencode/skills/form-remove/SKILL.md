---
name: form-remove
description: "Этот скилл MUST быть вызван когда пользователь просит удалить/убрать форму из объекта 1С. SHOULD также вызывать при очистке неиспользуемых форм. Do NOT использовать для удаления элементов формы — используй form-edit."
---
