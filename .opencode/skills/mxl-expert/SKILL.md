---
name: mxl-expert
description: "Этот скилл MUST быть вызван для всех операций с MXL-макетами и шаблонами объектов 1С: создание MXL из JSON (compile), получение JSON из MXL (decompile), добавление макета к объекту (template-add), удаление макета (template-remove). SHOULD также вызывать при любой работе с печатными формами и макетами. Do NOT использовать для анализа MXL — используй inspect; для валидации — используй validate."
---
