...
description: "Этот скилл MUST быть вызван для всех операций с подсистемами и командным интерфейсом 1С: создание подсистемы (compile), редактирование состава (edit), настройка командного интерфейса (interface-edit). SHOULD также вызывать при организации объектов конфигурации в логические группы. Do NOT использовать для анализа подсистемы — используй inspect; для валидации — validate."
---
