---
name: web-stop
description: "Этот скилл MUST быть вызван когда пользователь просит остановить веб-сервер, Apache, прекратить веб-публикацию. SHOULD также вызывать когда веб-публикации больше не нужны. Do NOT использовать для удаления публикаций — используй web-unpublish; для проверки статуса — используй web-info."
---
