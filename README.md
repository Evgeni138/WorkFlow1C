...
| Сервер | Назначение |
|--------|-----------|
| `rlm-tools-bsl` | Token-efficient анализ BSL-кодовых баз (поиск, вызовы, ссылки) |
| `bsl-language-server` | Линт/диагностики BSL, карточки символов, справка по платформе |
