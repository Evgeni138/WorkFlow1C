...
**Шаг 3: Настройка в клиенте**

Добавьте в конфиг MCP вашего клиента (в opencode — секция `mcp` в `opencode.jsonc`):
...
3. Увеличьте timeout в конфиге MCP клиента (в opencode — `opencode.jsonc`)
